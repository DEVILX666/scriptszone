...
export default function RobloxScriptsLanding() {
  ...
  // Handle download button click - now calls og_load()
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white relative overflow-hidden font-sans">
      ...
      >
        ...
        >
          ...
          >
            <span className="bg-gradient-to-r from-[#8a2be2] via-[#00bfff] to-[#00ff88] text-transparent bg-clip-text">
              GAMEPLAY VIDEO WITH SCRIPTS
            </span>
          </motion.h2>

          <motion.div
            className="rounded-xl overflow-hidden shadow-[0_0_30px_rgba(0,255,136,0.2)] border border-[#00ff88]/20"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div
              dangerouslySetInnerHTML={{
                __html: `<div style="position:relative; width:100%; height:0px; padding-bottom:56.250%"><iframe allow="fullscreen" allowfullscreen height="100%" src="https://streamable.com/e/6jvuo7?loop=0" width="100%" style="border:none; width:100%; height:100%; position:absolute; left:0px; top:0px; overflow:hidden;"></iframe></div>`,
              }}
            />
          </motion.div>
        </motion.section>
