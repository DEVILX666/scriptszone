        ...
        <div className="relative p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2 pt-2">
            <div className="text-sm sm:text-base font-bold tracking-wide">
              <span className="green-glow font-black text-lg sm:text-xl">50+</span>
          ...
          <Button className="w-full bg-gradient-to-r from-primary to-secondary hover:opacity-90 transition-opacity text-sm sm:text-base py-5 sm:py-6 font-semibold">
