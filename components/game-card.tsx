...
export function GameCard({ game }: GameCardProps) {
  ...
  const gameLockerUrls = {
    "99 Nights in the Forest": "https://scriptsunlocker.com/cl/i/n66or9",
    "Steal a Brainrot": "https://scriptsunlocker.com/cl/i/o46o84",
    "Escape Tsunami For Brainrots": "https://scriptsunlocker.com/cl/i/5nnrd3",
    "Blox Fruits": "https://scriptsunlocker.com/cl/i/4oo4n1",
        ...
        <div className="relative p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <Button
            className={`w-full bg-gradient-to-r from-primary to-secondary hover:opacity-90 transition-all duration-300 text-sm sm:text-base py-5 sm:py-6 font-semibold ${
              isPreparing ? "animate-pulse preparing-animation" : ""
            }`}
            disabled={isPreparing}
          >
            <Download className={`w-4 h-4 mr-2 ${isPreparing ? "animate-spin" : ""}`} />
            {isPreparing ? "Preparing Scripts..." : "Get Scripts"}
          </Button>
        </div>
      </Card>
